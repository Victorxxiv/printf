 ...
 * Developed in conjunction by Victor and Cindy.
...
/**
 * write_number - Function that prints a number. Developed
 * by Victor and Cindy.
...
/**
 * write_unsgnd - Function to write an unsigned number. Developed in conjunction by Victor and Cindy.
 * @is_negative: Indicates if the number is negative.
 * @ind: Index.
 * @buffer: Buffer array to handle print.
 * @flags: Calculates active flags.
